...
- [33.1 Inference vs. Training Traffic Taxonomy](#331-inference-vs-training-traffic-taxonomy)
- [33.2 Prefill and Decode Phases: Compute and Bandwidth Profiles](#332-prefill-and-decode-phases-compute-and-bandwidth-profiles)
  - [33.2.1 Prefill Phase](#3321-prefill-phase)
  - [33.2.2 Decode Phase](#3322-decode-phase)
- [33.3 Disaggregated Prefill/Decode Architecture](#333-disaggregated-prefilldecode-architecture)
  - [33.3.1 When to Disaggregate](#3331-when-to-disaggregate)
- [33.4 KV Cache Size Estimation](#334-kv-cache-size-estimation)
- [33.5 KV Cache RDMA Transfer](#335-kv-cache-rdma-transfer)
  - [33.5.1 GPUDirect and DMA-BUF](#3351-gpudirect-and-dma-buf)
  - [33.5.2 NVLink vs. RoCEv2 for KV Migration](#3352-nvlink-vs-rocev2-for-kv-migration)
  - [33.5.3 NIXL — NVIDIA Inference Transfer Library](#3353-nixl-nvidia-inference-transfer-library)
  - [33.5.4 Mooncake Transfer Engine](#3354-mooncake-transfer-engine)
- [33.6 vLLM Disaggregated Prefill/Decode](#336-vllm-disaggregated-prefilldecode)
  - [33.6.1 Connector Architecture](#3361-connector-architecture)
  - [33.6.2 Distributed Executor and Tensor Parallelism](#3362-distributed-executor-and-tensor-parallelism)
- [33.7 SGLang: RadixAttention and Hierarchical Caching](#337-sglang-radixattention-and-hierarchical-caching)
  - [33.7.1 RadixAttention](#3371-radixattention)
  - [33.7.2 HiCache — Hierarchical KV Storage](#3372-hicache-hierarchical-kv-storage)
  - [33.7.3 EPD Disaggregation with Mooncake](#3373-epd-disaggregation-with-mooncake)
- [33.8 NVIDIA Dynamo: Network Architecture](#338-nvidia-dynamo-network-architecture)
  - [33.8.1 Control Plane: Smart Router](#3381-control-plane-smart-router)
  - [33.8.2 Data Plane: NIXL KV Transfer](#3382-data-plane-nixl-kv-transfer)
  - [33.8.3 Grove: Topology-Aware Worker Placement](#3383-grove-topology-aware-worker-placement)
  - [33.8.4 NIC and Fabric Requirements for Dynamo](#3384-nic-and-fabric-requirements-for-dynamo)
- [33.9 TensorRT-LLM Executor](#339-tensorrt-llm-executor)
- [33.10 Triton Inference Server: gRPC Endpoint Sizing](#3310-triton-inference-server-grpc-endpoint-sizing)
  - [33.10.1 NIC Utilization from Dynamic Batching](#33101-nic-utilization-from-dynamic-batching)
- [33.11 Speculative Decoding Communication](#3311-speculative-decoding-communication)
  - [33.11.1 Communication Patterns](#33111-communication-patterns)
- [33.12 Load Balancing Inference Endpoints](#3312-load-balancing-inference-endpoints)
  - [33.12.1 Decision Tree: Routing Strategy Selection](#33121-decision-tree-routing-strategy-selection)
  - [33.12.2 Consistent Hashing for KV Cache Locality](#33122-consistent-hashing-for-kv-cache-locality)
  - [33.12.3 Power-of-Two-Choices for Decode Nodes](#33123-power-of-two-choices-for-decode-nodes)
  - [33.12.4 Gateway API Inference Extension](#33124-gateway-api-inference-extension)
- [33.13 Fabric Design Implications](#3313-fabric-design-implications)
  - [33.13.1 Spine-Leaf Sizing for Inference](#33131-spine-leaf-sizing-for-inference)
  - [33.13.2 TTFT Latency Budget](#33132-ttft-latency-budget)
  - [33.13.3 Storage Network for Model Weight Loading](#33133-storage-network-for-model-weight-loading)
- [33.14 Lab: Disaggregated Inference Simulation with Soft-RoCE](#3314-lab-disaggregated-inference-simulation-with-soft-roce)
  - [Lab Step 1 — Install Python RDMA bindings](#lab-step-1-install-python-rdma-bindings)
  - [Lab Step 2 — Verify Connectivity with ibv_rc_pingpong](#lab-step-2-verify-connectivity-with-ibvrcpingpong)
  - [Lab Step 3 — Baseline Latency at Small Message Sizes](#lab-step-3-baseline-latency-at-small-message-sizes)
  - [Lab Step 4 — Measure Bandwidth at KV-Representative Sizes](#lab-step-4-measure-bandwidth-at-kv-representative-sizes)
  - [Lab Step 5 — Build TTFT Model from Measurements](#lab-step-5-build-ttft-model-from-measurements)
- [33.15 Summary](#3315-summary)
