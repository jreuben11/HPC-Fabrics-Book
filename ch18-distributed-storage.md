...
- [Installation](#installation)
  ...
  - [Ceph via cephadm (bootstraps the full daemon set)](#ceph-via-cephadm-bootstraps-the-full-daemon-set)
  - [MinIO server and client](#minio-server-and-client)
  - [fio (flexible I/O tester)](#fio-flexible-io-tester)
  - [Python environment for S3/object storage scripting](#python-environment-for-s3object-storage-scripting)
  - [WEKA client (requires WEKA cluster; shown for reference)](#weka-client-requires-weka-cluster-shown-for-reference)
- [18.1 Storage as a Fabric Concern](#181-storage-as-a-fabric-concern)
- [18.2 Ceph — Unified Distributed Object Storage](#182-ceph-unified-distributed-object-storage)
  - [18.2.1 Architecture](#1821-architecture)
  - [18.2.2 CRUSH Map — Data Placement](#1822-crush-map-data-placement)
  - [18.2.3 Pool and Performance Tuning](#1823-pool-and-performance-tuning)
  - [18.2.4 CephFS for Shared Dataset Access](#1824-cephfs-for-shared-dataset-access)
- [18.3 Lustre — HPC Parallel Filesystem](#183-lustre-hpc-parallel-filesystem)
  - [18.3.1 Architecture](#1831-architecture)
  - [18.3.2 Installation and Configuration](#1832-installation-and-configuration)
  - [18.3.3 Striping for AI Workloads](#1833-striping-for-ai-workloads)
  - [18.3.4 LNet — Lustre Networking](#1834-lnet-lustre-networking)
- [18.4 DAOS — Distributed Asynchronous Object Storage](#184-daos-distributed-asynchronous-object-storage)
  - [18.4.1 Architecture](#1841-architecture)
  - [18.4.2 Pool and Container Model](#1842-pool-and-container-model)
  - [18.4.3 DAOS for Checkpoint Performance](#1843-daos-for-checkpoint-performance)
- [18.5 WEKA — NVMe-Native Parallel Filesystem](#185-weka-nvme-native-parallel-filesystem)
  - [18.5.1 Architecture](#1851-architecture)
  - [18.5.2 Why WEKA for AI Workloads](#1852-why-weka-for-ai-workloads)
  - [18.5.3 Client Installation](#1853-client-installation)
  - [18.5.4 Key CLI Commands](#1854-key-cli-commands)
  - [18.5.5 WEKA Tiering — NVMe Hot Tier + S3 Cold Tier](#1855-weka-tiering-nvme-hot-tier-s3-cold-tier)
  - [18.5.6 Checkpoint Workload Comparison: Lustre vs DAOS vs WEKA](#1856-checkpoint-workload-comparison-lustre-vs-daos-vs-weka)
- [18.6 MinIO — S3-Compatible Object Storage](#186-minio-s3-compatible-object-storage)
- [18.7 Storage Network Isolation](#187-storage-network-isolation)
  - [GPU training fabric (RDMA / RoCEv2):](#gpu-training-fabric-rdma-rocev2)
  - [Storage fabric (RDMA or iSCSI):](#storage-fabric-rdma-or-iscsi)
  - [Management fabric (Ethernet):](#management-fabric-ethernet)
- [Lab Walkthrough 18 — Single-Node Ceph (cephadm), RBD Benchmarking with fio, OSD Failure Simulation, and MinIO S3 Operations](#lab-walkthrough-18-single-node-ceph-cephadm-rbd-benchmarking-with-fio-osd-failure-simulation-and-minio-s3-operations)
  - [Step 1 — Bootstrap a single-node Ceph cluster](#step-1-bootstrap-a-single-node-ceph-cluster)
  - [Step 2 — Wait for cluster health OK and add an OSD](#step-2-wait-for-cluster-health-ok-and-add-an-osd)
  - [Step 3 — Create a pool and RBD image](#step-3-create-a-pool-and-rbd-image)
  - [Step 4 — Map the RBD image and create a filesystem](#step-4-map-the-rbd-image-and-create-a-filesystem)
  - [Step 5 — fio benchmark on the RBD block device](#step-5-fio-benchmark-on-the-rbd-block-device)
  - [Step 6 — OSD failure simulation and rebalancing observation](#step-6-osd-failure-simulation-and-rebalancing-observation)
  - [Step 7 — MinIO lab: server, bucket operations, file upload/download](#step-7-minio-lab-server-bucket-operations-file-uploaddownload)
  - [Step 8 — Python boto3 upload/download script (complete, runnable)](#step-8-python-boto3-uploaddownload-script-complete-runnable)
  - [Step 9 — fio comparison: local NVMe vs RBD vs MinIO (NFS-backed)](#step-9-fio-comparison-local-nvme-vs-rbd-vs-minio-nfs-backed)
