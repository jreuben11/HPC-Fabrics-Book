...
- [29.1 Why Standard Kubernetes Scheduling Breaks for AI](#291-why-standard-kubernetes-scheduling-breaks-for-ai)
  - [Gang Scheduling Requirement](#gang-scheduling-requirement)
  - [Topology Blindness](#topology-blindness)
  - [Resource Fragmentation](#resource-fragmentation)
- [Installation](#installation)
  - [System packages](#system-packages)
  - [Kind — local multi-node cluster](#kind-local-multi-node-cluster)
  - [Helm](#helm)
  - [vcctl — Volcano CLI](#vcctl-volcano-cli)
  - [Python environment](#python-environment)
- [29.2 Gang Scheduling Concepts](#292-gang-scheduling-concepts)
  - [PodGroup and min-member](#podgroup-and-min-member)
  - [All-or-Nothing Semantics](#all-or-nothing-semantics)
  - [Starvation and Deadlock Risks](#starvation-and-deadlock-risks)
- [29.3 Volcano Scheduler](#293-volcano-scheduler)
  - [Queue](#queue)
  - [Volcano Job](#volcano-job)
  - [vcctl CLI](#vcctl-cli)
  - [Bin-packing vs Spread Policies](#bin-packing-vs-spread-policies)
- [29.4 Kueue — Workload Queueing and Admission](#294-kueue-workload-queueing-and-admission)
  - [Core CRDs](#core-crds)
  - [Admission Flow](#admission-flow)
- [29.5 Coscheduler — Gang Scheduling as a Scheduler Plugin](#295-coscheduler-gang-scheduling-as-a-scheduler-plugin)
  - [Architecture Difference from Volcano](#architecture-difference-from-volcano)
  - [PodGroup with Coscheduler](#podgroup-with-coscheduler)
- [29.6 Topology-Aware Scheduling](#296-topology-aware-scheduling)
  - [NUMA Awareness](#numa-awareness)
  - [GPU Topology — NVLink and PCIe](#gpu-topology-nvlink-and-pcie)
  - [NIC Affinity for RDMA](#nic-affinity-for-rdma)
  - [topologySpreadConstraints](#topologyspreadconstraints)
- [29.7 Network Implications of Scheduling Decisions](#297-network-implications-of-scheduling-decisions)
  - [How Pod Placement Determines AllReduce Ring Topology](#how-pod-placement-determines-allreduce-ring-topology)
  - [Traffic Crosses Spine vs Not](#traffic-crosses-spine-vs-not)
  - [Rank-to-NIC Mapping](#rank-to-nic-mapping)
- [29.8 Practical Scheduling Policy](#298-practical-scheduling-policy)
  - [Priority Classes for Training vs Inference](#priority-classes-for-training-vs-inference)
  - [Preemption Order](#preemption-order)
  - [Quota Management Across Teams](#quota-management-across-teams)
- [29.9 Beyond Pure Kubernetes: SLURM, RunAI, and NVIDIA Dynamo](#299-beyond-pure-kubernetes-slurm-runai-and-nvidia-dynamo)
  - [29.9.1 SLURM — HPC Workload Manager](#2991-slurm-hpc-workload-manager)
  - [29.9.2 RunAI — GPU Scheduling Platform](#2992-runai-gpu-scheduling-platform)
  - [29.9.3 NVIDIA Dynamo — Inference Serving Framework](#2993-nvidia-dynamo-inference-serving-framework)
  - [29.9.4 Choosing Between Schedulers](#2994-choosing-between-schedulers)
- [Lab Walkthrough 29 — Gang Scheduling with Volcano and Topology-Aware Placement](#lab-walkthrough-29-gang-scheduling-with-volcano-and-topology-aware-placement)
  - [Step 1 — Create a 3-node Kind cluster with node labels](#step-1-create-a-3-node-kind-cluster-with-node-labels)
  - [Step 2 — Install Volcano via Helm](#step-2-install-volcano-via-helm)
  - [Step 3 — Create a Volcano Queue with guaranteed capacity](#step-3-create-a-volcano-queue-with-guaranteed-capacity)
  - [Step 4 — Submit a PodGroup and Job with minMember=2](#step-4-submit-a-podgroup-and-job-with-minmember2)
  - [Step 5 — Demonstrate gang scheduling guarantee with insufficient nodes](#step-5-demonstrate-gang-scheduling-guarantee-with-insufficient-nodes)
  - [Step 6 — Install Kueue and create ResourceFlavor, ClusterQueue, LocalQueue](#step-6-install-kueue-and-create-resourceflavor-clusterqueue-localqueue)
  - [Step 7 — Submit a batch of jobs via Kueue and observe admission](#step-7-submit-a-batch-of-jobs-via-kueue-and-observe-admission)
  - [Step 8 — Write topology_advisor.py](#step-8-write-topologyadvisorpy)
  - [Step 9 — Apply topologySpreadConstraints to pin a 4-pod job to rack-1](#step-9-apply-topologyspreadconstraints-to-pin-a-4-pod-job-to-rack-1)
  - [Step 10 — Show the AllReduce topology difference quantitatively](#step-10-show-the-allreduce-topology-difference-quantitatively)
