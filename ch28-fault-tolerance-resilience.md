...
- [28.1 Why Network Faults Kill Training Jobs](#281-why-network-faults-kill-training-jobs)
  - [RDMA Timeout Cascades](#rdma-timeout-cascades)
  - [AllReduce Barrier Hang](#allreduce-barrier-hang)
  - [Checkpoint Loss](#checkpoint-loss)
- [Installation](#installation)
  - [System packages](#system-packages)
  - [Python environment](#python-environment)
  - [Verify RDMA tooling](#verify-rdma-tooling)
- [28.2 BFD — Bidirectional Forwarding Detection](#282-bfd-bidirectional-forwarding-detection)
  - [BFD Timer Arithmetic](#bfd-timer-arithmetic)
  - [BFD in FRR](#bfd-in-frr)
  - [BFD Integration with BGP Convergence](#bfd-integration-with-bgp-convergence)
- [28.3 RDMA Timeout and Retry Tuning](#283-rdma-timeout-and-retry-tuning)
  - [QP Attributes for Reliability](#qp-attributes-for-reliability)
  - [Querying Error Counters](#querying-error-counters)
  - [Mellanox ethtool Counters](#mellanox-ethtool-counters)
- [28.4 PFC Watchdog — Preventing Lossless Fabric Deadlocks](#284-pfc-watchdog-preventing-lossless-fabric-deadlocks)
  - [PFC Storm Detection](#pfc-storm-detection)
  - [Configuring the PFC Watchdog](#configuring-the-pfc-watchdog)
- [28.5 Training Job Recovery with torchrun](#285-training-job-recovery-with-torchrun)
  - [torchrun Elastic Parameters](#torchrun-elastic-parameters)
  - [c10d Store Failover](#c10d-store-failover)
  - [NCCL Timeout](#nccl-timeout)
  - [Re-rendezvous Sequence](#re-rendezvous-sequence)
- [28.6 Checkpoint Strategies for Network Resilience](#286-checkpoint-strategies-for-network-resilience)
  - [Synchronous vs Asynchronous Checkpointing](#synchronous-vs-asynchronous-checkpointing)
  - [Check-and-Restart Pattern](#check-and-restart-pattern)
  - [DMTCP for Transparent Checkpointing](#dmtcp-for-transparent-checkpointing)
- [28.7 Watchdog and Circuit-Breaker Patterns](#287-watchdog-and-circuit-breaker-patterns)
  - [Health-Probe Sidecar](#health-probe-sidecar)
  - [Exponential Backoff for Reconnect](#exponential-backoff-for-reconnect)
  - [Circuit Breaker for Collective Operations](#circuit-breaker-for-collective-operations)
- [28.8 Observability for Fault Detection](#288-observability-for-fault-detection)
  - [RDMA Error Counter Alerts in Prometheus](#rdma-error-counter-alerts-in-prometheus)
  - [BFD State Change via gNMI](#bfd-state-change-via-gnmi)
  - [Correlating NCCL Timeouts with Link Events](#correlating-nccl-timeouts-with-link-events)
- [Lab Walkthrough 28 — BFD Link Failure Detection and NCCL Timeout Recovery](#lab-walkthrough-28-bfd-link-failure-detection-and-nccl-timeout-recovery)
  - [Step 1 — Create a Containerlab 3-node FRR topology and deploy](#step-1-create-a-containerlab-3-node-frr-topology-and-deploy)
  - [Step 2 — Enable BFD on all BGP sessions with aggressive timers](#step-2-enable-bfd-on-all-bgp-sessions-with-aggressive-timers)
  - [Step 3 — Show BFD peer state](#step-3-show-bfd-peer-state)
  - [Step 4 — Simulate link failure and measure detection time](#step-4-simulate-link-failure-and-measure-detection-time)
  - [Step 5 — Show BGP convergence after BFD triggers withdrawal](#step-5-show-bgp-convergence-after-bfd-triggers-withdrawal)
  - [Step 6 — Write fault_injector.py](#step-6-write-faultinjectorpy)
  - [Step 7 — Write a 2-rank AllReduce script and run with torchrun](#step-7-write-a-2-rank-allreduce-script-and-run-with-torchrun)
  - [Step 8 — Kill rank 1 mid-AllReduce and observe timeout](#step-8-kill-rank-1-mid-allreduce-and-observe-timeout)
  - [Step 9 — Enable automatic restart with torchrun --max-restarts](#step-9-enable-automatic-restart-with-torchrun-max-restarts)
  - [Step 10 — Monitor RDMA error counters and export to Prometheus](#step-10-monitor-rdma-error-counters-and-export-to-prometheus)
