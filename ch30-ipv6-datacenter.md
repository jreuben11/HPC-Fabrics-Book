...
- [30.1 Why IPv6 in AI Cluster Fabrics](#301-why-ipv6-in-ai-cluster-fabrics)
  - [30.1.1 Address Space Exhaustion at Scale](#3011-address-space-exhaustion-at-scale)
  - [30.1.2 Simplified Subnetting](#3012-simplified-subnetting)
  - [30.1.3 No NAT](#3013-no-nat)
  - [30.1.4 SLAAC — Stateless Address Autoconfiguration](#3014-slaac-stateless-address-autoconfiguration)
- [Installation](#installation)
  - [System packages (Ubuntu 24.04)](#system-packages-ubuntu-2404)
  - [Containerlab](#containerlab)
  - [Python environment](#python-environment)
  - [FRR (Free Range Routing)](#frr-free-range-routing)
- [30.2 IPv6 Addressing for Datacenter Fabrics](#302-ipv6-addressing-for-datacenter-fabrics)
  - [30.2.1 Prefix Hierarchy](#3021-prefix-hierarchy)
  - [30.2.2 Link-Local Addresses for Routing Peering](#3022-link-local-addresses-for-routing-peering)
  - [30.2.3 Loopback /128](#3023-loopback-128)
  - [30.2.4 Practical Address Assignment](#3024-practical-address-assignment)
- [30.3 Dual-Stack BGP with FRR](#303-dual-stack-bgp-with-frr)
  - [30.3.1 Architecture](#3031-architecture)
  - [30.3.2 FRR Configuration: IPv4 + IPv6 Address Families](#3032-frr-configuration-ipv4-ipv6-address-families)
  - [30.3.3 Verification Commands](#3033-verification-commands)
- [30.4 IPv6 EVPN/VXLAN](#304-ipv6-evpnvxlan)
  - [30.4.1 Type 2 Routes — MAC/IP Advertisement with IPv6](#3041-type-2-routes-macip-advertisement-with-ipv6)
  - [30.4.2 Type 5 Routes — IPv6 Prefix Routes](#3042-type-5-routes-ipv6-prefix-routes)
  - [30.4.3 Symmetric IRB with IPv6](#3043-symmetric-irb-with-ipv6)
- [30.5 Cilium Dual-Stack](#305-cilium-dual-stack)
  - [30.5.1 Enabling Dual-Stack in Cilium](#3051-enabling-dual-stack-in-cilium)
  - [30.5.2 Dual-Stack Services](#3052-dual-stack-services)
  - [30.5.3 IPv6 Network Policy](#3053-ipv6-network-policy)
- [30.6 SR Linux Dual-Stack](#306-sr-linux-dual-stack)
  - [30.6.1 Interface IPv6 Configuration](#3061-interface-ipv6-configuration)
  - [30.6.2 BGP IPv6 AFI/SAFI on SR Linux](#3062-bgp-ipv6-afisafi-on-sr-linux)
  - [30.6.3 Verification](#3063-verification)
- [30.7 IPv6 Gotchas in AI Clusters](#307-ipv6-gotchas-in-ai-clusters)
  - [30.7.1 RDMA over IPv6 — RoCEv2](#3071-rdma-over-ipv6-rocev2)
  - [30.7.2 PTP over IPv6](#3072-ptp-over-ipv6)
  - [30.7.3 NFS/RDMA over IPv6](#3073-nfsrdma-over-ipv6)
  - [30.7.4 NCCL and Gloo over IPv6](#3074-nccl-and-gloo-over-ipv6)
- [Lab Walkthrough 30 — Dual-Stack Containerlab Fabric with FRR BGP](#lab-walkthrough-30-dual-stack-containerlab-fabric-with-frr-bgp)
  - [Step 1 — Create the Containerlab topology](#step-1-create-the-containerlab-topology)
  - [Step 2 — Configure FRR dual-stack BGP on both nodes](#step-2-configure-frr-dual-stack-bgp-on-both-nodes)
  - [Step 3 — Verify both BGP sessions Established](#step-3-verify-both-bgp-sessions-established)
  - [Step 4 — Verify IPv6 prefixes exchanged](#step-4-verify-ipv6-prefixes-exchanged)
  - [Step 5 — Write and run dual_stack_test.py with Scapy](#step-5-write-and-run-dualstacktestpy-with-scapy)
  - [Step 6 — Configure IPv6 SLAAC with radvd on a Linux host container](#step-6-configure-ipv6-slaac-with-radvd-on-a-linux-host-container)
  - [Step 7 — Neighbor Discovery with ndisc6](#step-7-neighbor-discovery-with-ndisc6)
  - [Step 8 — Show IPv6 routing table and end-to-end ping](#step-8-show-ipv6-routing-table-and-end-to-end-ping)
  - [Step 9 — IPv6-only pitfall: NCCL interface and PyTorch Gloo over IPv6 loopback](#step-9-ipv6-only-pitfall-nccl-interface-and-pytorch-gloo-over-ipv6-loopback)
  - [Step 10 — Containerlab destroy and cleanup](#step-10-containerlab-destroy-and-cleanup)
- [Summary](#summary)
