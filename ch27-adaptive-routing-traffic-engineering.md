...
- [27.1 ECMP Limitations: Why Static Hashing Fails for AllReduce](#271-ecmp-limitations-why-static-hashing-fails-for-allreduce)
  - [The 5-Tuple Hash Collision Problem](#the-5-tuple-hash-collision-problem)
  - [Elephant Flow Concentration](#elephant-flow-concentration)
  - [Why Static Hashing Cannot Be Fixed by Configuration Alone](#why-static-hashing-cannot-be-fixed-by-configuration-alone)
- [Installation](#installation)
  - [System packages](#system-packages)
  - [Containerlab](#containerlab)
  - [Python scripting environment (uv)](#python-scripting-environment-uv)
- [27.2 Flowlet Switching](#272-flowlet-switching)
  - [The Core Insight](#the-core-insight)
  - [FLOWLET_TIMEOUT Selection](#flowlettimeout-selection)
  - [SONiC Flowlet Configuration](#sonic-flowlet-configuration)
- [27.3 NVIDIA/Mellanox Adaptive Routing](#273-nvidiamellanox-adaptive-routing)
  - [Per-Packet Load Balancing Mechanics](#per-packet-load-balancing-mechanics)
  - [AR Algorithm Options](#ar-algorithm-options)
  - [AR Threshold](#ar-threshold)
  - [RDMA/RoCE Interaction](#rdmaroce-interaction)
- [27.4 Packet Spraying for RDMA](#274-packet-spraying-for-rdma)
  - [How It Works](#how-it-works)
  - [DCQCN Interaction](#dcqcn-interaction)
  - [When to Use Packet Spraying vs Flowlet Switching](#when-to-use-packet-spraying-vs-flowlet-switching)
- [27.5 SRv6 for DC Traffic Engineering](#275-srv6-for-dc-traffic-engineering)
  - [SRv6 SID Structure](#srv6-sid-structure)
  - [Key SRv6 Behaviors](#key-srv6-behaviors)
  - [FRR SRv6 Configuration](#frr-srv6-configuration)
  - [SRH Insertion (Steering Traffic)](#srh-insertion-steering-traffic)
- [27.6 UCMP: Unequal Cost Multi-Path](#276-ucmp-unequal-cost-multi-path)
  - [BGP Link Bandwidth Community](#bgp-link-bandwidth-community)
  - [Enabling UCMP in FRR](#enabling-ucmp-in-frr)
- [27.7 Measuring and Diagnosing ECMP Imbalance](#277-measuring-and-diagnosing-ecmp-imbalance)
  - [Per-Port Counter Collection](#per-port-counter-collection)
- [Lab Walkthrough 27 — ECMP Hash Collision Detection and Flowlet Switching](#lab-walkthrough-27-ecmp-hash-collision-detection-and-flowlet-switching)
  - [Step 1 — Deploy 2-Spine / 2-Leaf Containerlab Topology](#step-1-deploy-2-spine-2-leaf-containerlab-topology)
  - [Step 2 — Configure ECMP BGP on Spines and Leaves](#step-2-configure-ecmp-bgp-on-spines-and-leaves)
  - [Step 3 — Generate 4 Parallel iperf3 Flows, Collect Per-Interface Counters](#step-3-generate-4-parallel-iperf3-flows-collect-per-interface-counters)
  - [Step 4 — Write ecmp_balance.py: Imbalance Ratio Calculator](#step-4-write-ecmpbalancepy-imbalance-ratio-calculator)
  - [Step 5 — Scapy: Demonstrate Hash Collision with Identical 5-Tuples](#step-5-scapy-demonstrate-hash-collision-with-identical-5-tuples)
  - [Step 6 — Vary Source Port with Scapy to Demonstrate 5-Tuple Distribution](#step-6-vary-source-port-with-scapy-to-demonstrate-5-tuple-distribution)
  - [Step 7 — Enable Flowlet Switching in SONiC-VS, Re-run Experiment](#step-7-enable-flowlet-switching-in-sonic-vs-re-run-experiment)
  - [Step 8 — SRv6 Basic Configuration in FRR](#step-8-srv6-basic-configuration-in-frr)
  - [Step 9 — UCMP with BGP Link Bandwidth Community](#step-9-ucmp-with-bgp-link-bandwidth-community)
