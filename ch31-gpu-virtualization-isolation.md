...
- [Installation](#installation)
  - [Phase A: Physical host prerequisites](#phase-a-physical-host-prerequisites)
  - [Phase B: Laptop / CI prerequisites](#phase-b-laptop-ci-prerequisites)
- [31.1 GPU Isolation Taxonomy and Decision Matrix](#311-gpu-isolation-taxonomy-and-decision-matrix)
- [31.2 VFIO and IOMMU: The Kernel Foundation](#312-vfio-and-iommu-the-kernel-foundation)
  - [31.2.1 IOMMU Groups](#3121-iommu-groups)
  - [31.2.2 ACS Override Patch](#3122-acs-override-patch)
  - [31.2.3 vfio-pci Driver Binding](#3123-vfio-pci-driver-binding)
  - [31.2.4 ROM BAR Issues](#3124-rom-bar-issues)
- [31.3 KVM/QEMU GPU Passthrough](#313-kvmqemu-gpu-passthrough)
  - [31.3.1 OVMF UEFI Firmware](#3131-ovmf-uefi-firmware)
  - [31.3.2 Huge-Page-Backed Guest RAM](#3132-huge-page-backed-guest-ram)
  - [31.3.3 QEMU Device Assignment Command](#3133-qemu-device-assignment-command)
- [31.4 libvirt/virsh: XML-Based GPU Passthrough](#314-libvirtvirsh-xml-based-gpu-passthrough)
  - [31.4.1 Detaching the Device from the Host](#3141-detaching-the-device-from-the-host)
  - [31.4.2 Domain XML: `<hostdev>` PCI Passthrough](#3142-domain-xml-hostdev-pci-passthrough)
  - [31.4.3 Network Backend Choices](#3143-network-backend-choices)
- [31.5 Proxmox VE: GPU Passthrough in Production](#315-proxmox-ve-gpu-passthrough-in-production)
  - [31.5.1 IOMMU and VFIO Kernel Setup](#3151-iommu-and-vfio-kernel-setup)
  - [31.5.2 Creating a GPU VM with qm](#3152-creating-a-gpu-vm-with-qm)
  - [31.5.3 PCIe Bifurcation for Multi-GPU Hosts](#3153-pcie-bifurcation-for-multi-gpu-hosts)
  - [31.5.4 Proxmox Networking Stack](#3154-proxmox-networking-stack)
  - [31.5.5 Corosync Cluster Quorum and HA](#3155-corosync-cluster-quorum-and-ha)
  - [31.5.6 Ceph RBD Storage Integration](#3156-ceph-rbd-storage-integration)
- [31.6 NVIDIA MIG: Hardware GPU Partitioning](#316-nvidia-mig-hardware-gpu-partitioning)
  - [31.6.1 GI/CI Hierarchy](#3161-gici-hierarchy)
  - [31.6.2 MIG Profile Catalogue](#3162-mig-profile-catalogue)
  - [31.6.3 MIG CLI Walkthrough](#3163-mig-cli-walkthrough)
  - [31.6.4 MIG in Kubernetes: NVIDIA GPU Operator](#3164-mig-in-kubernetes-nvidia-gpu-operator)
  - [31.6.5 NCCL Behavior Across MIG Slices](#3165-nccl-behavior-across-mig-slices)
- [31.7 NVIDIA MPS: Multi-Process Service](#317-nvidia-mps-multi-process-service)
  - [31.7.1 CUDA Context Sharing Model](#3171-cuda-context-sharing-model)
  - [31.7.2 Starting the MPS Daemon](#3172-starting-the-mps-daemon)
  - [31.7.3 Per-Client Memory and Thread Limits](#3173-per-client-memory-and-thread-limits)
  - [31.7.4 Stopping the MPS Daemon](#3174-stopping-the-mps-daemon)
  - [31.7.5 MPS vs MIG: Isolation vs Sharing Granularity](#3175-mps-vs-mig-isolation-vs-sharing-granularity)
- [31.8 KubeVirt: GPU VMs Inside Kubernetes](#318-kubevirt-gpu-vms-inside-kubernetes)
  - [31.8.1 Core CRDs and virtctl](#3181-core-crds-and-virtctl)
  - [31.8.2 GPU Passthrough via `devices.gpus`](#3182-gpu-passthrough-via-devicesgpus)
  - [31.8.3 DataVolume for VM Disk Provisioning](#3183-datavolume-for-vm-disk-provisioning)
  - [31.8.4 Network Binding Modes](#3184-network-binding-modes)
  - [31.8.5 Live Migration Constraints](#3185-live-migration-constraints)
- [31.9 Networking Consequences: RDMA, GPUDirect, and Isolation](#319-networking-consequences-rdma-gpudirect-and-isolation)
  - [31.9.1 GPUDirect RDMA Mechanism](#3191-gpudirect-rdma-mechanism)
  - [31.9.2 RDMA Device Visibility in VMs](#3192-rdma-device-visibility-in-vms)
  - [31.9.3 GPUDirect with VFIO Passthrough](#3193-gpudirect-with-vfio-passthrough)
  - [31.9.4 IOMMU and DMA-Remapping Impact on GPU P2P](#3194-iommu-and-dma-remapping-impact-on-gpu-p2p)
  - [31.9.5 Why vGPU Abstractions Break GPUDirect](#3195-why-vgpu-abstractions-break-gpudirect)
- [31.10 Decision Matrix: Choosing the Right Model](#3110-decision-matrix-choosing-the-right-model)
- [Lab: Phase A — Proxmox GPU Passthrough (Requires Physical Hardware)](#lab-phase-a-proxmox-gpu-passthrough-requires-physical-hardware)
  - [Step 1: Enable IOMMU](#step-1-enable-iommu)
  - [Step 2: Load VFIO Modules](#step-2-load-vfio-modules)
  - [Step 3: Identify GPU PCI Address](#step-3-identify-gpu-pci-address)
  - [Step 4: Dump ROM (if needed)](#step-4-dump-rom-if-needed)
  - [Step 5: Create and Configure GPU VM](#step-5-create-and-configure-gpu-vm)
  - [Step 6: Start VM and Verify GPU Inside](#step-6-start-vm-and-verify-gpu-inside)
- [Lab: Phase B — KubeVirt VMI with SR-IOV Secondary NIC (No GPU Required)](#lab-phase-b-kubevirt-vmi-with-sr-iov-secondary-nic-no-gpu-required)
  - [Step 1: Create Kind Cluster and Install KubeVirt](#step-1-create-kind-cluster-and-install-kubevirt)
  - [Step 2: Install Multus and SR-IOV (Soft-RoCE simulation)](#step-2-install-multus-and-sr-iov-soft-roce-simulation)
  - [Step 3: Deploy VMI with Secondary Network Attachment](#step-3-deploy-vmi-with-secondary-network-attachment)
  - [Step 4: Verify Secondary NIC Attachment (SR-IOV Workflow Simulation)](#step-4-verify-secondary-nic-attachment-sr-iov-workflow-simulation)
