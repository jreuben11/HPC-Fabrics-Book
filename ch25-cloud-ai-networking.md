...
- [Installation](#installation)
  ...
  - [aws-ofi-nccl build from source](#aws-ofi-nccl-build-from-source)
- [25.1 On-Prem vs Cloud AI Networking: What Changes](#251-on-prem-vs-cloud-ai-networking-what-changes)
  - [25.1.1 Physical Access and Fabric Control](#2511-physical-access-and-fabric-control)
  - [25.1.2 Software Stack Differences](#2512-software-stack-differences)
  - [25.1.3 Instance Placement and Proximity](#2513-instance-placement-and-proximity)
- [25.2 AWS EFA: Elastic Fabric Adapter](#252-aws-efa-elastic-fabric-adapter)
  - [25.2.1 Architecture](#2521-architecture)
  - [25.2.2 EFA-Capable Instance Types](#2522-efa-capable-instance-types)
  - [25.2.3 Cluster Placement Group](#2523-cluster-placement-group)
  - [25.2.4 EFA Provider Query](#2524-efa-provider-query)
  - [25.2.5 NCCL + EFA Integration](#2525-nccl-efa-integration)
- [25.3 Azure RDMA: HBv3 and NDv5](#253-azure-rdma-hbv3-and-ndv5)
  - [25.3.1 Azure RDMA Driver Stack](#2531-azure-rdma-driver-stack)
  - [25.3.2 hpc-x MPI Stack](#2532-hpc-x-mpi-stack)
  - [25.3.3 Proximity Placement Groups](#2533-proximity-placement-groups)
- [25.4 GCP GPUDirect-TCPX](#254-gcp-gpudirect-tcpx)
  - [25.4.1 Architecture](#2541-architecture)
  - [25.4.2 A3 Instance and tcpxo Configuration](#2542-a3-instance-and-tcpxo-configuration)
  - [25.4.3 TCPX vs Standard TCP NCCL](#2543-tcpx-vs-standard-tcp-nccl)
- [25.5 Cloud-Specific NCCL Tuning](#255-cloud-specific-nccl-tuning)
  - [25.5.1 Critical Environment Variables](#2551-critical-environment-variables)
  - [25.5.2 Topology File Generation](#2552-topology-file-generation)
  - [25.5.3 Bandwidth Baselines by Instance Type](#2553-bandwidth-baselines-by-instance-type)
- [25.6 Multi-Node Cluster Networking in Cloud](#256-multi-node-cluster-networking-in-cloud)
  - [25.6.1 VPC Design for AI Clusters](#2561-vpc-design-for-ai-clusters)
  - [25.6.2 Inter-AZ Latency Impact on AllReduce](#2562-inter-az-latency-impact-on-allreduce)
  - [25.6.3 Elastic Fabric Adapter Limits](#2563-elastic-fabric-adapter-limits)
- [25.7 Cloud vs On-Prem Decision Matrix](#257-cloud-vs-on-prem-decision-matrix)
- [Lab Walkthrough 25 — libfabric Provider Comparison: shm vs tcp vs simulated efa](#lab-walkthrough-25-libfabric-provider-comparison-shm-vs-tcp-vs-simulated-efa)
  - [Step 1: Install libfabric and survey available providers](#step-1-install-libfabric-and-survey-available-providers)
  - [Step 2: Inspect the shm provider in depth](#step-2-inspect-the-shm-provider-in-depth)
  - [Step 3: Inspect the tcp provider](#step-3-inspect-the-tcp-provider)
  - [Step 4: fi_pingpong latency with shm provider](#step-4-fipingpong-latency-with-shm-provider)
  - [Step 5: fi_msg_bw bandwidth with shm provider](#step-5-fimsgbw-bandwidth-with-shm-provider)
  - [Step 6: fi_pingpong with tcp provider — compare with shm](#step-6-fipingpong-with-tcp-provider-compare-with-shm)
  - [Step 7: Write nccl_env_advisor.py](#step-7-write-ncclenvadvisorpy)
  - [Step 8: aws-ofi-nccl build and plugin discovery](#step-8-aws-ofi-nccl-build-and-plugin-discovery)
  - [Step 9: Topology file generation script](#step-9-topology-file-generation-script)
