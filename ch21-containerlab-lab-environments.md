...
- [Installation](#installation)
  ...
  - [gnmic (gNMI client for telemetry verification)](#gnmic-gnmi-client-for-telemetry-verification)
  - [iperf3](#iperf3)
  - [Python environment (netmiko, paramiko, pyyaml)](#python-environment-netmiko-paramiko-pyyaml)
- [21.1 Infrastructure-as-Code for Network Labs](#211-infrastructure-as-code-for-network-labs)
- [21.2 Containerlab Architecture](#212-containerlab-architecture)
- [21.3 Topology YAML — Anatomy](#213-topology-yaml-anatomy)
- [21.4 Node Kinds](#214-node-kinds)
  - [SR Linux](#sr-linux)
  - [SONiC-VS](#sonic-vs)
  - [FRR Container as Host Router](#frr-container-as-host-router)
  - [Packet Generator (iperf3)](#packet-generator-iperf3)
- [21.5 CLI Workflow](#215-cli-workflow)
- [21.6 VM-Based Nodes via vrnetlab](#216-vm-based-nodes-via-vrnetlab)
- [21.7 CI Integration](#217-ci-integration)
- [21.8 GPU Cluster Fabric Topology in Containerlab](#218-gpu-cluster-fabric-topology-in-containerlab)
- [21.9 Out-of-Band Management Networks](#219-out-of-band-management-networks)
  - [Baseboard Management Controllers](#baseboard-management-controllers)
  - [IPMI](#ipmi)
  - [Redfish](#redfish)
  - [OOB Network Topology](#oob-network-topology)
  - [Containerlab's `mgmt` Network as a Software OOB Analogue](#containerlabs-mgmt-network-as-a-software-oob-analogue)
  - [`ipmitool` and Redfish in CI](#ipmitool-and-redfish-in-ci)
- [21.10 Choosing a Local Kubernetes Environment](#2110-choosing-a-local-kubernetes-environment)
  - [Why This Book Uses Kind](#why-this-book-uses-kind)
...
- [Lab Walkthrough 21 — GPU Rail Fabric: Full Step-by-Step](#lab-walkthrough-21-gpu-rail-fabric-full-step-by-step)
  ...
  - [Step 3: Write the Complete GPU Rail Fabric Topology YAML](#step-3-write-the-complete-gpu-rail-fabric-topology-yaml)
  - [Step 4: Deploy the Topology](#step-4-deploy-the-topology)
  - [Step 5: Inspect the Running Topology](#step-5-inspect-the-running-topology)
  - [Step 6: SSH into spine1 and Configure eBGP](#step-6-ssh-into-spine1-and-configure-ebgp)
  - [Step 7: SSH into tor-rail0 and Verify eBGP Configuration](#step-7-ssh-into-tor-rail0-and-verify-ebgp-configuration)
  - [Step 8: Configure Server Interfaces](#step-8-configure-server-interfaces)
  - [Step 9: Wait for BGP Convergence and Poll](#step-9-wait-for-bgp-convergence-and-poll)
  - [Step 10: Verify ECMP — 2 Paths to Each Server Prefix](#step-10-verify-ecmp-2-paths-to-each-server-prefix)
  - [Step 11: Run iperf3 Between server1 and server2 (Rail 0)](#step-11-run-iperf3-between-server1-and-server2-rail-0)
  - [Step 12: Packet Capture on a Specific Link](#step-12-packet-capture-on-a-specific-link)
  - [Step 13: Tear Down the Topology](#step-13-tear-down-the-topology)
  - [Step 14: Add This Topology as a GitHub Actions CI Job](#step-14-add-this-topology-as-a-github-actions-ci-job)
- [Summary](#summary)
