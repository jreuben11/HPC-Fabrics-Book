...
- [Installation](#installation)
  ...
  - [Soft-IB kernel module](#soft-ib-kernel-module)
  - [Python uv environment](#python-uv-environment)
- [24.1 IB vs RoCEv2: Transport Model Differences](#241-ib-vs-rocev2-transport-model-differences)
  - [24.1.1 Transport Encapsulation](#2411-transport-encapsulation)
  - [24.1.2 The Subnet Manager: IB's Central Difference](#2412-the-subnet-manager-ibs-central-difference)
  - [24.1.3 When to Choose Each Transport](#2413-when-to-choose-each-transport)
- [24.2 IB Subnet Manager: OpenSM](#242-ib-subnet-manager-opensm)
  - [24.2.1 opensm Configuration](#2421-opensm-configuration)
  - [24.2.2 Starting OpenSM](#2422-starting-opensm)
  - [24.2.3 SM Failover and Priority](#2423-sm-failover-and-priority)
  - [24.2.4 subnet.lst](#2424-subnetlst)
- [24.3 Fabric Discovery Tools](#243-fabric-discovery-tools)
  - [24.3.1 ibstat and ibstatus](#2431-ibstat-and-ibstatus)
  - [24.3.2 ibnetdiscover](#2432-ibnetdiscover)
  - [24.3.3 ibdiagnet](#2433-ibdiagnet)
  - [24.3.4 ibping and ibsysstat](#2434-ibping-and-ibsysstat)
- [24.4 Fat-Tree Routing Algorithms](#244-fat-tree-routing-algorithms)
  - [24.4.1 Linear Forwarding Tables (LFTs)](#2441-linear-forwarding-tables-lfts)
  - [24.4.2 FTREE Routing Engine](#2442-ftree-routing-engine)
  - [24.4.3 LASH: Layer Assignment for Source Hopping](#2443-lash-layer-assignment-for-source-hopping)
  - [24.4.4 DOR: Dimension Order Routing](#2444-dor-dimension-order-routing)
  - [24.4.5 Viewing Computed LFTs](#2445-viewing-computed-lfts)
- [24.5 Priority Flow Control: Lossless IB vs Lossy Ethernet](#245-priority-flow-control-lossless-ib-vs-lossy-ethernet)
  - [24.5.1 Native IB Lossless Operation](#2451-native-ib-lossless-operation)
  - [24.5.2 Priority Flow Control on Ethernet Switches](#2452-priority-flow-control-on-ethernet-switches)
  - [24.5.3 PFC Deadlock Detection and Prevention](#2453-pfc-deadlock-detection-and-prevention)
- [24.6 Performance Counters and Monitoring](#246-performance-counters-and-monitoring)
  - [24.6.1 perfquery](#2461-perfquery)
  - [24.6.2 Sysfs RDMA Counters](#2462-sysfs-rdma-counters)
  - [24.6.3 ibdump: Packet Capture](#2463-ibdump-packet-capture)
  - [24.6.4 Prometheus Integration with rdma_exporter](#2464-prometheus-integration-with-rdmaexporter)
- [24.7 Soft-IB (rdma_rxe) as a Lab Stand-In](#247-soft-ib-rdmarxe-as-a-lab-stand-in)
  - [24.7.1 Capabilities](#2471-capabilities)
  - [24.7.2 Known Limitations for Lab Work](#2472-known-limitations-for-lab-work)
- [Lab Walkthrough 24 — OpenSM Subnet Manager + Fabric Diagnostics (Soft-IB rxe)](#lab-walkthrough-24-opensm-subnet-manager-fabric-diagnostics-soft-ib-rxe)
  - [Step 1: Load the rxe module and create a veth pair](#step-1-load-the-rxe-module-and-create-a-veth-pair)
  - [Step 2: Attach rxe devices to both veth interfaces](#step-2-attach-rxe-devices-to-both-veth-interfaces)
  - [Step 3: Start OpenSM on the first rxe device](#step-3-start-opensm-on-the-first-rxe-device)
  - [Step 4: Verify port state with ibstat and ibstatus](#step-4-verify-port-state-with-ibstat-and-ibstatus)
  - [Step 5: Run ibnetdiscover — full topology dump](#step-5-run-ibnetdiscover-full-topology-dump)
  - [Step 6: Run ibdiagnet — error scan](#step-6-run-ibdiagnet-error-scan)
  - [Step 7: Read performance counters with perfquery](#step-7-read-performance-counters-with-perfquery)
  - [Step 8: Run ib_write_bw between the two rxe endpoints](#step-8-run-ibwritebw-between-the-two-rxe-endpoints)
  - [Step 9: Inject a fault — MTU mismatch, then re-run ibdiagnet](#step-9-inject-a-fault-mtu-mismatch-then-re-run-ibdiagnet)
