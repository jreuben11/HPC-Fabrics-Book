...
- [Installation](#installation)
  ...
  - [controller-gen (CRD manifest generator)](#controller-gen-crd-manifest-generator)
  - [Gateway API CRDs](#gateway-api-crds)
  - [Kind cluster with Cilium](#kind-cluster-with-cilium)
- [32.1 Kubernetes Extension Points — A One-Page Map](#321-kubernetes-extension-points-a-one-page-map)
- [32.2 CNI Spec in Depth](#322-cni-spec-in-depth)
  - [Why CNI Uses a Binary Protocol](#why-cni-uses-a-binary-protocol)
  - [32.2.1 Command Lifecycle: ADD / DEL / CHECK / GC / STATUS](#3221-command-lifecycle-add-del-check-gc-status)
  - [32.2.2 CNI Result JSON Schema](#3222-cni-result-json-schema)
  - [32.2.3 IPAM Delegation](#3223-ipam-delegation)
  - [32.2.4 Plugin Chaining via conflist](#3224-plugin-chaining-via-conflist)
  - [32.2.5 Writing a Minimal CNI Plugin in Go](#3225-writing-a-minimal-cni-plugin-in-go)
- [32.3 Device Plugin API](#323-device-plugin-api)
  - [Why a Separate API for Hardware](#why-a-separate-api-for-hardware)
  - [32.3.1 Registration Protocol](#3231-registration-protocol)
  - [32.3.2 gRPC Service Definition](#3232-grpc-service-definition)
  - [32.3.3 How `nvidia-device-plugin` Exposes `nvidia.com/gpu`](#3233-how-nvidia-device-plugin-exposes-nvidiacomgpu)
  - [32.3.4 How `rdma-shared-device-plugin` Exposes RDMA Resources](#3234-how-rdma-shared-device-plugin-exposes-rdma-resources)
  - [32.3.5 Writing a Stub Device Plugin](#3235-writing-a-stub-device-plugin)
- [32.4 Operator SDK / controller-runtime](#324-operator-sdk-controller-runtime)
  - [Why Operators Exist](#why-operators-exist)
  - [32.4.1 Scaffolding a New Operator](#3241-scaffolding-a-new-operator)
  - [32.4.2 CRD Type Definition with Kubebuilder Markers](#3242-crd-type-definition-with-kubebuilder-markers)
  - [32.4.3 Reconcile Loop](#3243-reconcile-loop)
  - [32.4.4 Deploying the Operator](#3244-deploying-the-operator)
- [32.5 Gateway API](#325-gateway-api)
  - [Why Gateway API Replaces Ingress](#why-gateway-api-replaces-ingress)
  - [32.5.1 Resource Model](#3251-resource-model)
  - [32.5.2 GatewayClass — Cilium's Implementation](#3252-gatewayclass-ciliums-implementation)
  - [32.5.3 Gateway — Defining a Listener](#3253-gateway-defining-a-listener)
  - [32.5.4 HTTPRoute — Routing Inference Traffic](#3254-httproute-routing-inference-traffic)
  - [32.5.5 GRPCRoute — Model Serving over gRPC](#3255-grpcroute-model-serving-over-grpc)
  - [32.5.6 TCPRoute — L4 Routing (Experimental)](#3256-tcproute-l4-routing-experimental)
  - [32.5.7 ReferenceGrant — Cross-Namespace Routing](#3257-referencegrant-cross-namespace-routing)
- [32.6 CRI and CSI Orientation](#326-cri-and-csi-orientation)
  - [Container Runtime Interface (CRI)](#container-runtime-interface-cri)
  - [Container Storage Interface (CSI)](#container-storage-interface-csi)
- [32.7 Putting It Together: The RDMANetwork Operator](#327-putting-it-together-the-rdmanetwork-operator)
  - [Design Intent](#design-intent)
  - [32.7.1 CRD Design](#3271-crd-design)
  - [32.7.2 Reconcile Loop Walkthrough](#3272-reconcile-loop-walkthrough)
  - [32.7.3 Using the RDMANetwork Operator](#3273-using-the-rdmanetwork-operator)
- [32.8 Lab: CNI Plugin + Device Plugin + Operator + Gateway API on Kind](#328-lab-cni-plugin-device-plugin-operator-gateway-api-on-kind)
  - [Prerequisites](#prerequisites)
  - [Lab Step 1 — Build and Deploy the Minimal CNI Plugin](#lab-step-1-build-and-deploy-the-minimal-cni-plugin)
  - [Lab Step 2 — Deploy the Stub Device Plugin](#lab-step-2-deploy-the-stub-device-plugin)
  - [Lab Step 3 — Deploy the NetworkTopology Operator via Operator SDK](#lab-step-3-deploy-the-networktopology-operator-via-operator-sdk)
  - [Lab Step 4 — Expose a Service via Cilium Gateway API HTTPRoute](#lab-step-4-expose-a-service-via-cilium-gateway-api-httproute)
  - [Lab Step 5 — Deploy the RDMANetwork Operator (stub mode)](#lab-step-5-deploy-the-rdmanetwork-operator-stub-mode)
- [Summary](#summary)
