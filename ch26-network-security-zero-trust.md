...
- [Installation](#installation)
  ...
  - [Kubernetes tooling (Kind + kubectl + Helm + Cilium CLI)](#kubernetes-tooling-kind-kubectl-helm-cilium-cli)
  - [Python scripting environment (uv)](#python-scripting-environment-uv)
- [26.1 Threat Model for AI Cluster Fabrics](#261-threat-model-for-ai-cluster-fabrics)
  - [Lateral Movement via the RDMA Fabric](#lateral-movement-via-the-rdma-fabric)
  - [Credential Theft from NIC Firmware](#credential-theft-from-nic-firmware)
  - [Management Plane Exposure](#management-plane-exposure)
  - [Summary Threat Matrix](#summary-threat-matrix)
- [26.2 Zero-Trust Principles Applied to the Fabric](#262-zero-trust-principles-applied-to-the-fabric)
  - [Identity, Not IP Address](#identity-not-ip-address)
  - [Mutual Authentication](#mutual-authentication)
  - [Least-Privilege Network Policy](#least-privilege-network-policy)
- [26.3 Cilium Transparent Encryption](#263-cilium-transparent-encryption)
  - [WireGuard Mode](#wireguard-mode)
  - [Verifying Encryption Status](#verifying-encryption-status)
  - [IPsec Mode](#ipsec-mode)
  - [Key Rotation](#key-rotation)
- [26.4 WireGuard for Overlay Encryption](#264-wireguard-for-overlay-encryption)
  - [Key Concepts](#key-concepts)
  - [Manual Configuration](#manual-configuration)
  - [wg-quick Configuration File](#wg-quick-configuration-file)
- [26.5 IPsec with strongSwan](#265-ipsec-with-strongswan)
  - [swanctl Configuration](#swanctl-configuration)
  - [Certificate Generation for IKEv2](#certificate-generation-for-ikev2)
- [26.6 mTLS Between Services: SPIFFE/SPIRE](#266-mtls-between-services-spiffespire)
  - [SPIRE Architecture in Kubernetes](#spire-architecture-in-kubernetes)
  - [SPIRE Deployment](#spire-deployment)
  - [cert-manager Integration](#cert-manager-integration)
- [26.7 Secrets Management with HashiCorp Vault](#267-secrets-management-with-hashicorp-vault)
  - [Vault PKI Secrets Engine](#vault-pki-secrets-engine)
  - [Vault Python Client (hvac)](#vault-python-client-hvac)
- [26.8 Network Policy as Code: Cilium CiliumNetworkPolicy](#268-network-policy-as-code-cilium-ciliumnetworkpolicy)
  - [Identity-Based Policy](#identity-based-policy)
  - [Audit Mode](#audit-mode)
  - [Hubble Policy Visualization](#hubble-policy-visualization)
- [26.9 MACsec: Layer 2 Link Encryption](#269-macsec-layer-2-link-encryption)
  - [Why MACsec Matters for AI Clusters](#why-macsec-matters-for-ai-clusters)
  - [MACsec Key Agreement (MKA)](#macsec-key-agreement-mka)
  - [Linux MACsec: Manual Static-Key Configuration](#linux-macsec-manual-static-key-configuration)
  - [MKA Automatic Key Distribution with wpa\_supplicant](#mka-automatic-key-distribution-with-wpasupplicant)
  - [Hardware Offload on NVIDIA ConnectX-7](#hardware-offload-on-nvidia-connectx-7)
  - [Limitations](#limitations)
  - [MACsec vs IPsec vs WireGuard Comparison](#macsec-vs-ipsec-vs-wireguard-comparison)
- [Lab Walkthrough 26 — WireGuard Encrypted Overlay + Cilium Transparent Encryption](#lab-walkthrough-26-wireguard-encrypted-overlay-cilium-transparent-encryption)
  - [Step 1 — Generate WireGuard Keypairs for Two Simulated Nodes](#step-1-generate-wireguard-keypairs-for-two-simulated-nodes)
  - [Step 2 — Create Network Namespaces with veth Pair, Configure WireGuard Interfaces](#step-2-create-network-namespaces-with-veth-pair-configure-wireguard-interfaces)
  - [Step 3 — Exchange Public Keys and Configure Peers with AllowedIPs](#step-3-exchange-public-keys-and-configure-peers-with-allowedips)
  - [Step 4 — wg show: Verify Handshake](#step-4-wg-show-verify-handshake)
  - [Step 5 — Ping Through the Encrypted Tunnel; tcpdump Confirms No Plaintext](#step-5-ping-through-the-encrypted-tunnel-tcpdump-confirms-no-plaintext)
  - [Step 6 — Measure WireGuard Overhead with iperf3](#step-6-measure-wireguard-overhead-with-iperf3)
  - [Step 7 — Enable Cilium Transparent Encryption on a Kind Cluster](#step-7-enable-cilium-transparent-encryption-on-a-kind-cluster)
  - [Step 8 — cilium encrypt status: Verify Encryption is Active on All Nodes](#step-8-cilium-encrypt-status-verify-encryption-is-active-on-all-nodes)
  - [Step 9 — Deploy Two Pods, Confirm Traffic is WireGuard-Encapsulated](#step-9-deploy-two-pods-confirm-traffic-is-wireguard-encapsulated)
  - [Step 10 — Key Rotation: cilium encrypt rotate-key](#step-10-key-rotation-cilium-encrypt-rotate-key)
